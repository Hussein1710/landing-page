  ...
  return (
    <div className='block sm:flex justify-around items-center bg-pink-100 border rounded sm:rounded-3xl mt-16 sm:m-28 px-1 sm:px-4 py-8'>
        <div className="p-4">
            ...
            <p className='w-[300px] sm:w-[470px] mt-3 font-ski text-[18px]'>Gleephoria has amazing features that enhances your privacy and tailors the best experience for you.</p>
